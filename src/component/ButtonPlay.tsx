    ...
    <div className="flex items-center justify-center">
      {Boolean(play && !firstStart) ? (
        <div className="flex justify-center items-center gap-3">
          <button
            className=" w-1/3 rounded-[10px] shadow  text-center px-3.5 bg-neutral-700 text-[34px] font-black text-emerald-500 flex justify-center items-center py-0.4  my-8 "
            onClick={() => {
          ...
          <button
            className=" w-1/3 rounded-[10px] shadow  text-center px-3.5 bg-neutral-700 text-[34px] font-black text-emerald-500 flex justify-center items-center py-1  my-8 "
            onClick={() => {
